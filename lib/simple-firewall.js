 ...
 * they're for public routes or if they come from users that have the proper role; 
 * otherwise, it responds to the request with a 401 or 403.
 *
 ...
 * object has a hasRole() method, that will be used to check whether the user is 
 * authorized see the route. hasRole can return a boolean or a Promise that resolves 
 * to a boolean, indicating whether the User has the role. 
 *
